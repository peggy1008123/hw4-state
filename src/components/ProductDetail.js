      ...
      <Col lg={{ span: 12 }}>
        <div className="product-info--detail">
          ...
          <div className="product-price-wrap">
            ...
            <Row>
            <Col span="4"><p className="product-qty">
              Qty: {"   "}
              <Select
                defaultValue={qty}
            ...
            <Col span="5" offset="8"><p className="product-qty">
              color: {"   "}{" "}
              <Select
                defaultValue={color}
                className="select-style"
            ...
            <Row>
              <Col span="4"><p className="product-qty">Total Price: {product.price * qty} </p></Col>{" "}
              <Col span="4" offset="8"><p className="product-qty">color: {color}</p></Col>
            </Row>
            <AddToCart />
          </div>{" "}
        </div>{" "}
